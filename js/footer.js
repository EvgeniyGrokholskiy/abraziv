            ...
            <div class="footer__center">
                <nav>
                    <ul class="footer__nav_menu footer__nav_menu-center">
                        <li class="footer__item"><a class="footer__link" href="#">Продукция</a></li>
                        <li class="footer__item"><a class="footer__link" href="#">Абразивы</a></li>
                        <li class="footer__item"><a class="footer__link" href="#">Средства защиты</a></li>
                        <li class="footer__item"><a class="footer__link" href="#">Сопутствующая продукция</a></li>
            ...
            <div class="footer__right">
                <div class="footer__contact_data">
                    ...
                    <p class="footer__address">
                        <span class="sign">
                            <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="16" height="21"
                    ...
                    <p class="footer__phone">
                        <span class="phone-sign">
                            <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="17" height="19"
